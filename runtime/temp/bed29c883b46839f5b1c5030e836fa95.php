<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:28:"./static/index\web_side.html";i:1508923826;s:24:"./static/index\base.html";i:1508923826;s:23:"./static/index\top.html";i:1508923826;s:23:"./static/index\nav.html";i:1508923826;s:26:"./static/index\footer.html";i:1508923826;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" data-original-title>
				...
				<div class="box-icon">
					<a href="<?php echo url('index/template/add',['title_id'=>$title_id]); ?>"><i class="halflings-icon white plus"></i></a>							
				</div>						
			</div>
			<div class="box-content">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							<th style="text-align: center;"><font><font>模板名称</font></font></th>
							<th style="text-align: center;"><font><font>页端</font></font></th>
							<th style="text-align: center;"><font><font>类型</font></font></th>
							<th style="text-align: center;"><font><font>种类</font></font></th>
					...
					<tbody>
						<?php if(is_array($webList) || $webList instanceof \think\Collection || $webList instanceof \think\Paginator): if( count($webList)==0 ) : echo "" ;else: foreach($webList as $key=>$vo): ?>
						<tr>
							<td style="text-align: center;overflow:hidden"><font><font><?php echo $vo['name']; ?></font></font></td>
							<td style="text-align: center;"><font><font><?php switch($vo['web_type']): case "10": ?>PC端<?php break; case "11": ?>H5端(WAP)<?php break; default: ?>PC端<?php endswitch; ?></font></font></td>
							<td style="text-align: center;"><font><font><?php switch($vo['type']): case "1": ?>爬虫模板<?php break; case "2": ?>前端模板<?php break; default: ?>爬虫模板<?php endswitch; ?></font></font></td>
							<td style="text-align: center;"><font><font><?php switch($vo['pertain_type']): case "1": ?>详情页模板<?php break; case "2": ?>首页模板<?php break; ?>{/case}<?php case "3": ?>聚合页模板<?php break; ?>{/case}<?php case "4": ?>客户官网模板<?php break; ?>{/case}<?php case "5": ?>流量优化页面<?php break; default: ?>详情页模板<?php endswitch; ?></font></font></td>
							...
							<td style="text-align: center;">											
								<a class="btn btn-info" href="<?php echo url('index/template/add',['title_id'=>$title_id,'material_id'=>$vo['id']]); ?>">
...
<script>
	$(document).on('click','.label',function(){
		...
		$.ajax({    
			type: 'POST',    
			url: "<?php echo url('index/template/status'); ?>",
			dataType:"json",    
			data:{
				"title_id":title_id
			},
