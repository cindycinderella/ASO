<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:32:"./static/index\custom_label.html";i:1508923826;s:24:"./static/index\base.html";i:1508923826;s:23:"./static/index\top.html";i:1508923826;s:23:"./static/index\nav.html";i:1508923826;s:26:"./static/index\footer.html";i:1508923826;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="row-fluid sortable">		
		<div class="box span12">
			...
			<div class="box-content">					                 	                       
				<form class="form-horizontal"  action="" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="status" value="<?php echo $navInfo['status']; ?>" />
					<input type="hidden" name="is_file" value="<?php echo $navInfo['is_file']; ?>" />
					<input type="hidden" name="pid" value="1" />
					<input type="hidden" name="nav_id" value="<?php echo $navInfo['id']; ?>" />							
					<input type="hidden" name="url" value="index/material/title" />							
					
					<fieldset>
						<div class="control-group">
							<label class="control-label"><font><font>显示</font></font></label>
							<div class="controls">
								<label class="checkbox inline">
									<div class="checker id="uniform-inlineCheckbox1"><span <?php if($navInfo['status']==1): ?> class="checked"<?php endif; ?> >
										<input type="checkbox" class="inlineCheckbox1" <?php if($navInfo['status']==1): ?> checked="checked" <?php endif; ?> value="1"></span></div><font><font><span>是</span>
									</font></font></label>
									<label class="checkbox inline">
										<div class="checker id="uniform-inlineCheckbox1"><span <?php if($navInfo['status']==-1): ?> class="checked"<?php endif; ?>>
											<input type="checkbox" class="inlineCheckbox1" <?php if($navInfo['status']==-1): ?> checked="checked" <?php endif; ?>  value="-1"></span></div><font><font><span>否</span>
										</font></font></label>
									</div>
								</div>    
								<div class="control-group">
									<label class="control-label" style="white-space: pre-wrap;"><font><font>内容是否是图片或者视频之类的</font></font></label>
									<div class="controls">
										<label class="checkbox inline">
											<div class="checker id="uniform-inlineCheckbox2"><span <?php if($navInfo['is_file']==1): ?> class="checked" <?php endif; ?>>
												<input type="checkbox" class="inlineCheckbox2" <?php if($navInfo['is_file']==1): ?> checked="checked" <?php endif; ?> value="1"></span></div><font><font><span>是</span>
											</font></font></label>
											<label class="checkbox inline">
												<div class="checker id="uniform-inlineCheckbox2"><span <?php if($navInfo['is_file']==-1): ?> class="checked" <?php endif; ?>>
													<input type="checkbox" class="inlineCheckbox2" <?php if($navInfo['is_file']==-1): ?> checked="checked" <?php endif; ?> value="-1"></span></div><font><font><span>否</span>
												</font></font></label>
											</div>
										</div>	
										<div class="control-group">
											<label class="control-label" for="inputSuccess"><font><font>标签名称</font></font></label>
											<div class="controls">
												<input type="text" name="name" value="<?php echo $navInfo['name']; ?>" >
											</div>
										</div> 
		...
		<script>		
			...
			$('.inlineCheckbox1').change(function(){
				...
				var cal = $(this).val()
				$("input[name='status']").val(cal);					
			})
			
			$('.inlineCheckbox2').change(function(){
				$('.inlineCheckbox2').parent('span').each(function(index, element) {
					$(this).removeClass("checked");
				});	
				$(this).parent('span').addClass("checked");
				var cal = $(this).val()
				$("input[name='is_file']").val(cal);				
			})
