<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:23:"./static/index\tag.html";i:1508923826;s:24:"./static/index\base.html";i:1508923826;s:23:"./static/index\top.html";i:1508923826;s:23:"./static/index\nav.html";i:1508923826;s:26:"./static/index\footer.html";i:1508923826;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" data-original-title>
				...
				<div class="box-icon">
					<a href="<?php echo url('index/nav/customlabel',['title_id'=>$title_id]); ?>"><i class="halflings-icon white plus"></i></a>							
				</div>						
			</div>
				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<th style="text-align: center;"><font><font>图片标签</font></font></th>
							<th style="text-align: center;"><font><font>显示</font></font></th>
					...
					<tbody>
						...
						<tr>
							<td style="text-align: center;overflow:hidden"><font><font><?php echo $vo['id']; ?></font></font></td>
							<td style="text-align: center;"><font><font><?php echo $vo['name']; ?></font></font></td>
							<td style="text-align: center;"><?php if($vo['is_file'] != 1): ?> 
								<span style="cursor:pointer;" class="label label-success is_file" alt="<?php echo $vo['id']; ?>"><font><font>否</font></font></span>
								<?php else: ?>
								<span style="cursor:pointer;" class="label label-important is_file" alt="<?php echo $vo['id']; ?>"><font><font>是</font></font></span>
								<?php endif; ?></td>
								<td style="text-align: center;"><?php if($vo['status'] == 1): ?> 
									<span style="cursor:pointer;" class="label label-success status" alt="<?php echo $vo['id']; ?>"><font><font>是</font></font></span>
									<?php else: ?>
									<span style="cursor:pointer;" class="label label-important status" alt="<?php echo $vo['id']; ?>"><font><font>否</font></font></span>
									<?php endif; ?></td>								
									<td style="text-align: center;">											
										<a class="btn btn-info" href="<?php echo url('index/nav/customlabel',['title_id'=>$title_id,'nav_id'=>$vo['id']]); ?>">
...
<script>
	$(document).on('click','.is_file',function(){
		...
		$.ajax({    
			type: 'POST',    
			url: "<?php echo url('index/nav/is_file'); ?>",
			dataType:"json",    
			data:{
				"title_id":title_id
			},
			success:function(data)
			{
				...
				{
					_this.parent('td').html('<span style="cursor:pointer;" class="label label-important is_file" alt="'+title_id+'"><font><font>是</font></font></span>');
				}else if(data.status==200)
				{
					_this.parent('td').html('<span style="cursor:pointer;" class="label label-success is_file" alt="'+title_id+'"><font><font>否</font></font></span>');	
				}else
				{
					$('.alert-error').find('strong').html(data.message);
					$('.alert-error').css('display','block')
	...
	$(document).on('click','.status',function(){
		...
		$.ajax({    
			type: 'POST',    
			url: "<?php echo url('index/nav/navStatus'); ?>",
			dataType:"json",    
			data:{
				"title_id":title_id
			},
			success:function(data)
			{
				...
				{
					_this.parent('td').html('<span style="cursor:pointer;" class="label label-success status" alt="'+title_id+'"><font><font>是</font></font></span>');
				}else if(data.status==200)
				{
					_this.parent('td').html('<span style="cursor:pointer;" class="label label-important status" alt="'+title_id+'"><font><font>否</font></font></span>');	
				}else
				{
					$('.alert-error').find('strong').html(data.message);
					$('.alert-error').css('display','block')
